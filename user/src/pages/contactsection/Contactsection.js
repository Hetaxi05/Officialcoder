        ...
        <div className="contact-container container mt-5 mb-5 " style={{ maxWidth: "100%" ,padding:"10px 150px" }}>
            <div className="row">
                ...
                <div className="col-lg-5">
                    <div className="office-info" style={{
                        border: "1px solid #ddd",
                        borderRadius: "10px",
                        padding: "50px",
                        // boxShadow: "0 0 10px rgba(0, 0, 0, 0.1)",
                        ...
                        <h2 style={{ color: "black", fontSize: "25px", fontFamily: "30px outfit, serif", fontWeight: "700" }}>Office Information</h2>
                        <p style={{ color: "#6C706F", marginBottom: "20px", fontFamily: "30px outfit, serif" }}>
                            Completely recapitalize 24/7 communities via standards compliant metrics whereas.
                        </p>

                        {/* Phone Number & Email */}
                        <div className="info-section d-flex align-items-center mb-2" style={{ marginBottom: "20px" }}>
                            <div
                                className="d-flex align-items-center justify-content-center"
                                style={iconBoxStyle("phone")}
                            ...
                            <div>
                                <h4 style={{ fontSize: "18px", color: "#333", marginBottom: "5px", fontFamily: "30px outfit, serif", fontWeight: "640" }}>
                                    Phone Number & Email
                                </h4>
                                <p style={{ color: "#6C706F", marginBottom: "5px", fontFamily: "30px outfit, serif" }}> (+91) - 9876543210 </p>
                                <p style={{ color: "#6C706F", fontFamily: "30px outfit, serif" }}> hello@officialcoders.com </p>
                            </div>
                        </div>
                        <hr style={{ borderTop: "1px solid black", margin: "10px 0", marginTop: "-5px" }} />
                        {/* Office Address */}
                        <div className="info-section d-flex align-items-center mb-2" style={{ marginBottom: "20px" }}>
                            <div
                                className="d-flex align-items-center justify-content-center"
                                style={iconBoxStyle("address")}
                            ...
                            <div>
                                ...
                                <p style={{ color: "#6C706F", fontFamily: "30px outfit, serif" }}>
                                    2690 Hilton Street Victoria Road, Surat, Gujrat
                                </p>
                            </div>
                        </div>
                        <hr style={{ borderTop: "1px solid black", margin: "10px 0", marginTop: "-5px" }} />
                        <div className="info-section d-flex align-items-center pt-2" >
                            <div
                                className="d-flex align-items-center justify-content-center"
                                style={iconBoxStyle("lock")}
                                onMouseEnter={() => handleMouseEnter("lock")}
                                onMouseLeave={handleMouseLeave}
                            >
                                <FaClock size={20} />
                            </div>
                            <div>
                                ...
                                <p style={{ color: "#6C706F", marginBottom: "5px", fontFamily: "30px outfit, serif" }}>Monday - Friday: 09:00 - 20:00</p>
                                <p style={{ color: "#6C706F", fontFamily: "30px outfit, serif" }}>Sunday & Saturday: 10:30 - 22:00</p>
                            </div>
                        </div>
                    </div>
                </div>
